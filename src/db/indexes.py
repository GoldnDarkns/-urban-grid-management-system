...
def create_indexes(db):
    ...
    print("✓ Created indexes for meter_readings")
    ...
    print("✓ Created indexes for air_climate_readings")
    ...
    print("✓ Created indexes for constraint_events")
    ...
    print("✓ Created indexes for grid_edges")
